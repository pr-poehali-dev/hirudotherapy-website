          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-border overflow-hidden hover:shadow-xl transition-shadow">
              <div className="relative group">
                <img
                  src="https://cdn.poehali.dev/projects/ee3c1d65-d52e-4bda-bcdd-78b87f238de8/files/f18103cf-9063-4641-a3fa-0da3d481f508.jpg"
              ...
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">Варикозное расширение вен</h3>
                <p className="text-muted-foreground text-sm">Курс из 10 сеансов, значительное улучшение состояния сосудов</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border overflow-hidden hover:shadow-xl transition-shadow">
              <div className="relative group">
                <img
                  src="https://cdn.poehali.dev/projects/ee3c1d65-d52e-4bda-bcdd-78b87f238de8/files/b03fb88c-2139-4e3c-9a5b-630b7ab9be54.jpg"
              ...
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">Заболевания суставов</h3>
                <p className="text-muted-foreground text-sm">Курс из 8 сеансов, уменьшение отёчности и болевого синдрома</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border overflow-hidden hover:shadow-xl transition-shadow">
              <div className="relative group">
                <img
                  src="https://cdn.poehali.dev/projects/ee3c1d65-d52e-4bda-bcdd-78b87f238de8/files/78aecbd1-7124-4d01-beb1-2d507d1c5e1b.jpg"
              ...
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">Улучшение кровообращения</h3>
                <p className="text-muted-foreground text-sm">Курс из 7 сеансов, нормализация микроциркуляции</p>
              </CardContent>
            </Card>
          </div>
